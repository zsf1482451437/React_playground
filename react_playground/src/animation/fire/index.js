...
class Fire extends THREE.Mesh {
  constructor(fireTex, color = new THREE.Color(0xfff)) {
...
export default function createThreeScene(container) {
  let camera, scene, renderer, fire;
  ...
  function init() {
    ...
    const fireTex = loader.load(
      'https://s3-us-west-2.amazonaws.com/s.cdpn.io/212131/Fire.png'
    );
  ...
  return {
    destroy: () => {
      ...
      container.removeChild(renderer.domElement); // 清理renderer
    },
  };
}
